const AboutPage = () => {
  return (
    <main className="w-full flex justify-center px-4 py-10 text-(--color-surface)">
      <section className="max-w-3xl bg-(--color-darkish) border border-(--color-border) rounded-2xl p-8 shadow-xl">
        <h1 className="text-3xl md:text-4xl font-bold text-(--color-primary) mb-6 text-center">
          About Chill Times
        </h1>
        ...
        <p className="text-(--color-primary-glow) text-lg font-semibold text-center">
